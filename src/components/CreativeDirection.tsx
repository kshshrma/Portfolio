...
export default function CreativeDirection() {
  const creativeData: CreativeItem[] = [
    {
      icon: <FaFilm className="text-[#3b82f6] text-2xl" />,
  ...
  return (
    <section id="creative" className="py-24 relative overflow-hidden bg-black text-white border-t border-white/5">
      <div className="absolute top-[20%] right-[-10%] w-[300px] h-[300px] bg-[#3b82f6]/5 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="container mx-auto px-6 max-w-5xl relative z-10">
        ...
        >
          <h2 className="text-sm font-bold uppercase tracking-wider text-blue-500 mb-2">05 . Visual Arts</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          {creativeData.map((item, idx) => (
            <motion.div
              ...
              className="glass-card p-6 border border-white/10 rounded-2xl bg-white/[0.01] flex gap-6 items-start hover:border-blue-500/25 transition-all cursor-pointer"
            >
              <div className="p-4 bg-white/5 rounded-xl border border-white/10 shrink-0">
                {item.icon}
              </div>
              <div className="space-y-2">
                <span className="text-[10px] font-bold text-blue-400 uppercase bg-blue-500/10 px-2.5 py-0.5 rounded-full tracking-wider border border-blue-500/10">
                  {item.badge}
                </span>
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-3 bg-blue-600 hover:bg-blue-500 text-white px-8 py-3.5 rounded-full font-bold text-sm transition-all shadow-[0_4px_20px_rgba(37,99,235,0.3)] hover:shadow-[0_4px_25px_rgba(37,99,235,0.5)] cursor-pointer"
          >
