...
export default function Projects() {
  const projectsData: ProjectItem[] = [
    ...
    },
    {
      id: "02",
      title: "StrayAid",
      description: "A community-driven support platform connecting local volunteers and veterinary services to report, rescue, and track injured stray animals via interactive coordinate mapping.",
      tech: ["React", "Node.js", "MongoDB", "Leaflet Maps", "Express"],
      github: "https://github.com/kshshrma/StrayAid",
    },
    {
      id: "03",
      title: "ManageScheduler",
      description: "An advanced task scheduling management dashboard designed to configure, trigger, and monitor automated cron jobs, asynchronous execution queues, and process health metrics.",
      tech: ["React", "Node.js", "Java", "MySQL", "Cron-scheduler"],
      github: "https://github.com/kshshrma/ManageScheduler",
    },
    {
      id: "04",
